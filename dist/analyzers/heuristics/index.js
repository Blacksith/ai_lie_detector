...
function confidenceFromRatio(ratio, floor = 0.5) {
    return clamp01(floor + Math.min(ratio, 1) * 0.5);
}
function dependencyKeyForImport(source) {
...
export function runHeuristicAnalyzer(params) {
    ...
    for (const file of params.files) {
        ...
        const verboseErrorCount = [
            ...file.content.matchAll(/throw\s+new\s+Error\(((?:"This function[^"]{10,}")|(?:'This function[^']{10,}')|(?:`This function[^`]{10,}`))\)/g),
        ].length;
